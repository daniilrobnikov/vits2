...
# TODO basedir = 'data/raw/LJSpeech-1.1' # import from config
basedir = "/gpfs/mariana/home/darobn/datasets/LJSpeech-1.1"
...
if __name__ == "__main__":
    ...
    subprocess.check_call(f"mkdir -p {basedir}/mfa_input_txt; " f"cp {basedir}/mfa_input/*/*.ph {basedir}/mfa_input_txt", shell=True)

    meta_ori_df["phone2"] = meta_ori_df.apply(lambda r: open(f"{basedir}/mfa_input_txt/{r['wav']}.ph").readlines()[0].strip(), 1)
